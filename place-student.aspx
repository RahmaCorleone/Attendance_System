<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="place-student.aspx.cs" Inherits="final_software.place_student" %>
...
<script id="applicationScript" type="text/javascript" src="place.js"></script>
</head>
<body>
<div id="place" class="place_Class">
	...
	<div class="yellow_hall_Class">
		<asp:ImageButton ID="yelloww_hall" runat="server" ImageUrl="yellow.svg" OnClick="yelloww_Click" />
	</div>
	</div>
	<div class="green_hall_Class">
		<asp:ImageButton ID="greenn_hall" runat="server" ImageUrl="green.svg" OnClick="greenn_Click" />
		
	</div>
	<div class="red_hall_Class">
		<asp:ImageButton ID="redd_hall" runat="server" ImageUrl="red.svg" OnClick="redd_Click" />
	</div>
	<div class="blue_hall_Class">
		<asp:ImageButton ID="bluee_hall" runat="server" ImageUrl="blue.svg" OnClick="bluee_Click" />
